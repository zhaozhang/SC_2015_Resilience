...
\begin{figure}[h]
        \begin{center}
                ...
                \vspace{-10pt}
                \caption{\kylenote{The graphs have lineage rather than re-execution.}Recovery performance of mImgtbl and mAdd due to a node failure occurred right after mBackground finishes and before mImgtbl starts
