...
Existing systems overcome node failure by resilient data access either through task re-execution or additional replicas. \katznote{prev is too blunt/general - if you are going to frame this as resilient data access, you first need to talk about the model you are using - data is primary, computing is secondary - overall state is stored via data - tasks are generally somewhat short-running - etc.}
...
#queue, Execute is the API to run the  
#queued tasks in parallel
=======
#for each file in rawdir/ we run a  
#mProject task with it as input file   
...
#tasks in parallel
>>>>>>> 03d9e15fe23901d92179317deb33fa37b3a8a96e
...
<<<<<<< HEAD
Lines 13--19 enqueue tasks; upon calling Line 19, all queued tasks are dispatched
to available compute nodes for execution. Line 27 is a simple example of AMFORA collective data movement:
=======
