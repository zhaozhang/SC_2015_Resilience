...
\label{sec:Perf}
We evaluate the adaptive method by emulating a supercomputer environment with an Amazon EC2 cluster of 64 m3.large instances, each equipped with 2 Intel Xeon E5-2670 vCPUs and 7.5~GB memory. 
...
%\zhaonote{yes, done}
and the re-execution score and replication score have a simpler form than in Equation~\ref{EQ:spatial} and ~\ref{EQ:temporal}
